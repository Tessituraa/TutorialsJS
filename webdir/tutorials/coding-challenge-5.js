 ...
 */
 ...
 /* 
    ...
    John likes to tip 20% of the bill when the bill is less than $50, 15% when the bill is between $50 and $200, and 10%
...
johnsBill = [124, 48, 268, 180, 42];

john = {
    bill: johnsBill,
    calcbill: function() {
        for (var i = 0; i < this.bill; i++) {
            switch (this.bill) {
                case this.bill <= 50:
                tip = 0.20;
                break;
                case this.bill >= 50 & this.bill <= 200:
                tip = 0.15;
                break;
                case this.bill >= 200:
                tip = 0.10;
